...
class ViewportEngine(Engine):
    ...
    def _sync_render_settings(self, scene):
        ...
        if settings.delegate == 'HdPrmanLoaderRendererPlugin':
            ...
            self.renderer.SetRendererSetting('convergedSamplesPerPixelMin', hdprman.min_samples)
            self.renderer.SetRendererSetting('convergedSamplesPerPixel', hdprman.max_samples)
